...
public class VistaServidorRMI extends JFrame {
  ...
  public void executeStart() {
    ...
    try {
      ...
      Naming.rebind("rmi://localhost:1099/RMILoginService", rmiObj);
      ...
      System.err.println("Error iniciando el servidor: " + e);
    }
  ...
  public static void main(String[] args) {
    VistaServidorRMI jfsr = new VistaServidorRMI();
