...
public class PantallaBajaCliente extends JDialog {
	...
	private ControladorPantallaBajaCliente cpl = null;
	private int idRegAux;
	private JLabel jLabelTarjCre = null;
	private JTextField jTextFieldNumTarjCred = null;
	
	public PantallaBajaCliente(AplicacionEmpleado ae,int idRegistro) {
		super(ae,"Baja Cliente",true);
		this.ae = ae;
		idRegAux = idRegistro;
		initialize();
	}
	...
	private void initialize() {
		...
		cpl = new ControladorPantallaBajaCliente(this,ae);
